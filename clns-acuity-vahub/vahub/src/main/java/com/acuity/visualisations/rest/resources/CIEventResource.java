...
public class CIEventResource {
    ...
    @Cacheable(condition = Constants.EMPTY_EVENT_AND_POPULATION_FILTER)
    public Filters<CIEvent> getAvailableFilters(@RequestBody @Valid CIEventRequest requestBody) {
    ...
    @Cacheable(condition = Constants.EMPTY_EVENT_AND_POPULATION_FILTER)
    public AxisOptions<CIEventGroupByOptions> getBarChartXAxis(@RequestBody @Valid CIEventRequest requestBody) {
    ...
    @Cacheable(condition = Constants.EMPTY_EVENT_AND_POPULATION_FILTER)
    public AxisOptions<CIEventGroupByOptions> getOverTimeChartXAxis(@RequestBody @Valid CIEventRequest requestBody) {
