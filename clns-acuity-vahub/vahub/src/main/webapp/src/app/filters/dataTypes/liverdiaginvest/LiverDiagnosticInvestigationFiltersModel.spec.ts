...
describe('GIVEN a LiverDiagnosticInvestigationFiltersModel class', () => {
    ...
    providers: [
        ...
        { provide: FilterEventService, useClass: MockFilterEventService },
        {
            ...
            useFactory: (p: PopulationFiltersModel, f: FilterHttpService, e: FilterEventService, d: DatasetViews): LiverDiagnosticInvestigationFiltersModel => new LiverDiagnosticInvestigationFiltersModel(p, f, e, d),
