...
describe('GIVEN a SurgicalHistoryFiltersModel class', () => {
    ...
    providers: [
        ...
        { provide: FilterEventService, useClass: MockFilterEventService },
        {
            ...
            useFactory: (p: PopulationFiltersModel, f: FilterHttpService, e: FilterEventService, d: DatasetViews): SurgicalHistoryFiltersModel => new SurgicalHistoryFiltersModel(p, f, e, d),
