...
export class LiverRiskFactorsTabComponent extends AbstractTabComponent implements OnInit {
    ...
    ngOnInit(): void {
        this._store.dispatch(new UpdateActiveTabId(TabId.SINGLE_SUBJECT_LIVER_RISK_FACTORS_TAB));
    }
}
