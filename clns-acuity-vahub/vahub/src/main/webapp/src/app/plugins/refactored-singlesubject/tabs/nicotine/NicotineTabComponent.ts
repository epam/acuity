...
export class NicotineTabComponent extends AbstractTabComponent implements OnInit {
    ...
    ngOnInit(): void {
        this._store.dispatch(new UpdateActiveTabId(TabId.SINGLE_SUBJECT_NICOTINE_TAB));
    }
}
