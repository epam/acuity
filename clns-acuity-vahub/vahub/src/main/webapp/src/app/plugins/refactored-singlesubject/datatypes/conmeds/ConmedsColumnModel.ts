...
export class ConmedsColumnModel extends AbstractColumnModel {
    _columnDefs: List<ColDef> = List([
        ...
        {field: 'endDate'},
        {field: 'duration'},
        {field: 'conmedTreatmentOngoing'},
        {field: 'studyDayAtConmedStart'},
        {field: 'startPriorToRandomisation'},
        {field: 'endPriorToRandomisation'},
        {field: 'treatmentReason'},
        {field: 'studyDayAtConmedEnd'},
        {field: 'doseFrequency'},
        {field: 'aePt', headerName: 'AE PT'},
        {field: 'aeNum', headerName: 'AE Number'}
    ]);
}
