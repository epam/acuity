...
export class RenalTabComponent extends AbstractTabComponent implements OnInit {
    ...
    ngOnInit(): void {
        this._store.dispatch(new UpdateActiveTabId(TabId.SINGLE_SUBJECT_RENAL_LINEPLOT));
    }
}
