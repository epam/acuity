...
@WebMvcTest(controllers = CardiacDetailsOnDemandResource.class)
public class CardiacDetailsOnDemandResourceTest {
    ...
    public void shouldDetailsOnDemandData() throws Exception {
        ...
        when(cardiacService.getDetailsOnDemandData(any(Datasets.class), anySet(), nullable(List.class), anyLong(), anyLong()))
