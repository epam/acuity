...
class Foundationmedicine_specimen(unittest.TestCase):
...
#         fm = foundationmedicine.FoundationMedicine("PRF500068_02.xml", "uomdevsqlserveret.database.windows.net", "et_python_process@uomdevsqlserveret.database.windows.net", "Funvax41!", "uom_dev_etarget_db", "uomdevstorageet", "GIGjJSDgeMf3bS8EJVclOHEPOz8/Dxan6wWYjJa73MSLT5IIkpo81ZHPy5cncvMWrVuuIbiKqEMvwYO7KvpKDw==", 'test')
        fm = foundationmedicine.FoundationMedicine("CUP0014573T1Blood.xml", "uomdevsqlserveret.database.windows.net", "et_python_process@uomdevsqlserveret.database.windows.net", "Funvax41!", "uom_dev_etarget_db", "uomdevstorageet", "GIGjJSDgeMf3bS8EJVclOHEPOz8/Dxan6wWYjJa73MSLT5IIkpo81ZHPy5cncvMWrVuuIbiKqEMvwYO7KvpKDw==", 'test')
#         fm.ingest()
        specimen_id, baseline, tar_id, source_txt=fm.getSpecimen()
        print(specimen_id)
