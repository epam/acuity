...
insert into users (username, fullname, password, enabled) values ('user001', 'glen d', 'password', 1);
insert into users (username, fullname, password, enabled) values ('kfgt12354', 'ste p', 'password', 1);
insert into users (username, fullname, password, enabled) values ('ksdgh854', 'mike f', 'password', 0);
insert into users (username, fullname, password, enabled) values ('ksdf5465667', 'bob p', 'password', 1);
