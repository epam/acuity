-- class
insert into acl_class (id, class) values (10, 'com.acuity.visualisations.security.acl.domain.DrugProgramme');
insert into acl_class (id, class) values (11, 'com.acuity.visualisations.security.acl.domain.ClinicalStudy');
insert into acl_class (id, class) values (12, 'com.acuity.visualisations.security.acl.domain.Visualisation');
