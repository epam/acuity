...
public class AcuityDatasetAllPermissions extends AcuityDataset {

    private final AcuityDataset acuityDataset;

    public AcuityDatasetAllPermissions(AcuityDataset acuityDataset) {
        this.acuityDataset = acuityDataset;
    }

    @Delegate(excludes = PermissionInfo.class)
    AcuityDataset getAcuityDataset() {
        return acuityDataset;
    }
    @Override
