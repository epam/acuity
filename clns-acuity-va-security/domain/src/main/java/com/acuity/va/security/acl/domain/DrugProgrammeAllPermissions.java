...
public class DrugProgrammeAllPermissions extends DrugProgramme {

    private final DrugProgramme drugProgramme;

    public DrugProgrammeAllPermissions(DrugProgramme drugProgramme) {
        this.drugProgramme = drugProgramme;
    }

    @Delegate(excludes = PermissionInfo.class)
    DrugProgramme getDrugProgramme() {
