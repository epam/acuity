...
public class DetectDatasetAllPermissions extends DetectDataset {

    private final DetectDataset detectDataset;

    public DetectDatasetAllPermissions(DetectDataset detectDataset) {
        this.detectDataset = detectDataset;
    }

    @Delegate(excludes = PermissionInfo.class)
    DetectDataset getDetectDataset() {
