...
public class TestingAuthenication extends TestingAuthenticationToken {
    ...
    private static final List<GrantedAuthority> roles = Lists.newArrayList(new SimpleGrantedAuthority("ACL_ADMINISTRATOR"), new SimpleGrantedAuthority("TRAINED_USER"));
