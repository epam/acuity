...
public class RunningPopulateAclsTaskService {

    private static Logger LOG = LoggerFactory.getLogger(RunningPopulateAclsTaskService.class);

    @Test
    public void shouldFindObjectIdentities() throws InterruptedException {
        Thread.sleep(5000);
    }
}
